...
def base_pool(inputs, op, psize, stride, padding,
              axis=-1, reuse=False, name=None, scope=None):
...
def base_pool_global(inputs, op, axis=-1, reuse=False, name=None, scope=None):
...
@layers
def avg_pool2d_global(inputs, axis=-1, reuse=False, name=None, scope=None):
