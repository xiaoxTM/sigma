...
import sigma
from sigma import layers, colors, dbs, status, helpers
import os.path
import numpy as np
...
def train(session, goptim, doptim, options,
    ...
    database = dbs.mnist.sampler(ddir, True, batch_size, onehot=True, nclass=nclass)
